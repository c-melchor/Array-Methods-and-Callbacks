...
console.log(`task two answer`,getFinals(fifaData));
...
let years = callback.map(function(team){
    return team.Year;
})
return years;
}
...
function getWinnersByYear(countries, years){
let str = countries.map((country, index) => {
...
let total= data.reduce(function(acc, item){
